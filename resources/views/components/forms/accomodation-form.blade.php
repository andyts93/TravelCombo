...
<form action="{{ $accomodation ? route('accomodation.update', $accomodation) : route('accomodation.store') }}" method="POST">
    ...
    <div class="grid md:grid-cols-2 gap-6">
        ...
        <div class="space-y-3">
            ...
            <x-text-input name="date_from" id="date_from" type="date" required value="{{ old('date_from', $accomodation?->date_from) }}"></x-text-input>
        ...
        <div class="space-y-3">
            ...
            <x-text-input name="date_to" id="date_to" type="date" required value="{{ old('date_to', $accomodation?->date_to) }}"></x-text-input>
